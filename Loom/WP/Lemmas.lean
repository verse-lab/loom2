...
theorem read_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem adapt_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : ρ → ρ') (x : ReaderT ρ' m α) :
    wp (ReaderT.adapt f x : ReaderT ρ m α) post epost =
      fun r => wp x (fun a _ => post a r) epost (f r) := rfl

/-! ## MonadStateOf simp lemmas -/

theorem get_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
theorem set_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : σ)
...
theorem modifyGet_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : σ → α × σ)
...
@[simp]
theorem modify_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : σ → σ) :
    wp (modify f : StateT σ m PUnit) post epost =
      wp (MonadStateOf.modifyGet fun s => (⟨⟩, f s) : StateT σ m PUnit) post epost := by
  rfl

@[simp]
theorem getModify_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : σ → σ) :
...
@[simp]
theorem throwThe_wp [MonadExceptOf ε m] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (err : ε) :
...
theorem throw_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (err : ε) :
...
theorem throw_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (err : PUnit) :
...
@[simp]
theorem tryCatch_MonadExcept_wp [MonadExceptOf ε m] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α)
    (h : ε → m α) :
...
@[simp]
theorem tryCatchThe_wp [MonadExceptOf ε m] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) (h : ε → m α) :
...
theorem tryCatch_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : ExceptT ε m α)
    (h : ε → ExceptT ε m α) :
...
@[simp]
theorem tryCatch_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : OptionT m α)
    (h : PUnit → OptionT m α) :
...
@[simp]
theorem getThe_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] :
    wp (getThe σ : StateT σ m σ) post epost =
      wp (MonadStateOf.get : StateT σ m σ) post epost := by
  rfl

@[simp]
theorem modifyThe_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : σ → σ) :
    wp (modifyThe σ f : StateT σ m PUnit) post epost =
      wp (MonadStateOf.modifyGet fun s => (⟨⟩, f s) : StateT σ m PUnit) post epost := by
  rfl

@[simp]
theorem modifyGetThe_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : σ → α × σ) :
    wp (modifyGetThe σ f : StateT σ m α) post epost =
      wp (MonadStateOf.modifyGet f : StateT σ m α) post epost := by
  rfl

@[simp]
theorem get_MonadState_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [MonadStateOf σ m] :
    wp (MonadState.get : m σ) post epost =
      wp (MonadStateOf.get : m σ) post epost := by
  rfl

@[simp]
theorem set_MonadState_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [MonadStateOf σ m] (x : σ) :
    wp (MonadState.set x : m PUnit) post epost =
      wp (MonadStateOf.set x : m PUnit) post epost := by
  rfl

@[simp]
theorem modifyGet_MonadState_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [MonadStateOf σ m] (f : σ → α × σ) :
    wp (MonadState.modifyGet f : m α) post epost =
      wp (MonadStateOf.modifyGet f : m α) post epost := by
  rfl

@[simp]
theorem read_MonadReader_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [MonadReaderOf ρ m] :
    wp (MonadReader.read : m ρ) post epost =
      wp (MonadReaderOf.read : m ρ) post epost := by
  rfl

@[simp]
theorem readThe_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] :
...
theorem monadLift_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) (post : α → σ → Pred) :
...
@[simp]
theorem monadLift_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) :
    wp (MonadLift.monadLift x : ReaderT ρ m α) post epost =
      fun r => wp x (fun a => post a r) epost := by
  rfl

theorem monadLift_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) (post : α → Pred)
...
@[simp]
theorem lift_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) :
    wp (StateT.lift x : StateT σ m α) post epost =
      wp (MonadLift.monadLift x : StateT σ m α) post epost := by
  rfl

@[simp]
theorem lift_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) :
    wp (ExceptT.lift x : ExceptT ε m α) post epost =
      wp (MonadLift.monadLift x : ExceptT ε m α) post epost := by
  rfl

@[simp]
theorem monadLift_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) :
  wp x post epost.tail ⊑
...
@[simp]
theorem lift_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem monadMap_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem monadMap_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem monadMap_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem monadMap_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem withReader_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : ρ → ρ) (x : ReaderT ρ m α) :
    wp (MonadWithReaderOf.withReader f x : ReaderT ρ m α) post epost =
      fun r => wp x (fun a _ => post a r) epost (f r) := rfl

@[simp]
theorem withReader_MonadWithReader_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [MonadWithReaderOf ρ m]
    (f : ρ → ρ) (x : m α) :
    wp (MonadWithReader.withReader f x : m α) post epost =
      wp (MonadWithReaderOf.withReader f x : m α) post epost := rfl

@[simp]
theorem withTheReader_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : ρ → ρ) (x : ReaderT ρ m α) :
...
theorem adapt_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (f : ε → ε') (x : ExceptT ε m α) :
...
@[simp]
theorem liftWith_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem liftWith_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem liftWith_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
@[simp]
theorem liftWith_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
...
theorem restoreM_StateT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m (α × σ)) :
...
@[simp]
theorem restoreM_ReaderT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m α) :
...
@[simp]
theorem restoreM_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m (Except ε α)) :
...
@[simp]
theorem restoreM_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : m (Option α)) :
...
@[simp]
theorem controlAt_wp [Bind n] [Monad n] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad n Pred EPred] [MonadControlT m n]
...
@[simp]
theorem control_wp [Bind n] [Monad n] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad n Pred EPred] [MonadControlT m n]
    (f : (∀{β}, n β → m (stM m n β)) → m (stM m n α)) :
...
@[simp]
theorem monadLift_trans_wp [Monad o] [Assertion Pred] [Assertion EPred] [WPMonad o Pred EPred] [MonadLift n o] [MonadLiftT m n] (x : m α) :
    wp (MonadLiftT.monadLift x : o α) post epost =
      wp (MonadLift.monadLift (m:=n) (MonadLiftT.monadLift (m:=m) x) : o α) post epost := rfl

@[simp]
theorem monadLift_refl_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [Pure m] (x : m α) :
    wp (MonadLiftT.monadLift x : m α) post epost =
      wp (x : m α) post epost := rfl

@[simp]
theorem monadMap_trans_wp [Monad o] [Assertion Pred] [Assertion EPred] [WPMonad o Pred EPred] [MonadFunctor n o] [MonadFunctorT m n]
    (x : o α) :
...
@[simp]
theorem monadMap_refl_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] [Pure m] (x : m α) :
...
theorem set_MonadStateOf_lift_wp [MonadStateOf σ m] [MonadLift m n] [Monad m] [Monad n]
    [Assertion Pred] [Assertion EPred'] [WPMonad n Pred EPred'] (x : σ) :
...
theorem modifyGet_MonadStateOf_lift_wp [MonadStateOf σ m] [MonadLift m n] [Monad m] [Monad n]
    [Assertion Pred] [Assertion EPred'] [WPMonad n Pred EPred'] (f : σ → α × σ) :
...
@[simp]
theorem throw_lift_ExceptT_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred'] [MonadExceptOf ε m]
    (err : ε) :
...
@[simp]
theorem throw_lift_OptionT_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred']
...
@[simp]
theorem tryCatch_lift_ExceptT_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred'] [MonadExceptOf ε m]
    (x : ExceptT ε' m α) (h : ε → ExceptT ε' m α) :
...
@[simp]
theorem tryCatch_lift_OptionT_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred']
...
@[simp]
theorem throw_ReaderT_lift_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred'] [MonadExceptOf ε m]
    (err : ε) :
...
@[simp]
theorem throw_StateT_lift_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred'] [MonadExceptOf ε m]
    (err : ε) :
...
@[simp]
theorem tryCatch_ReaderT_lift_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred'] [MonadExceptOf ε m]
...
@[simp]
theorem tryCatch_StateT_lift_wp [Monad m] [LawfulMonad m] [Assertion Pred] [Assertion EPred'] [WPMonad m Pred EPred'] [MonadExceptOf ε m]
...
@[simp]
theorem liftWith_trans_wp [Monad o] [Assertion Pred] [Assertion EPred] [WPMonad o Pred EPred] [MonadControl n o] [MonadControlT m n]
...
@[simp]
theorem liftWith_refl_wp [Pure m] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred]
    (f : (∀{β}, m β → m β) → m α) :
...
@[simp]
theorem restoreM_trans_wp [Monad o] [Assertion Pred] [Assertion EPred] [WPMonad o Pred EPred] [MonadControl n o] [MonadControlT m n]
    (x : stM m o α) :
...
@[simp]
theorem restoreM_refl_wp [Pure m] [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : stM m m α) :
...
@[simp]
theorem orElse_Except_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : Except ε α) (h : Unit → Except ε α) :
...
theorem orElse_ExceptT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : ExceptT ε m α)
...
@[simp]
theorem orElse_OptionT_wp [Monad m] [Assertion Pred] [Assertion EPred] [WPMonad m Pred EPred] (x : OptionT m α)
    (h : Unit → OptionT m α) :
  wp x post ⟨wp (h ()) post epost, epost.tail⟩ ⊑
