...
theorem Spec.monadLift_ExceptT (x : m α) (post : α → l) (epost : e × (ε → l)) :
...
theorem Spec.liftWith_StateT
  ...
  Triple.iff.mpr (by intro s; simp [liftWith_StateT_wp f]; apply WP.wp_map'; ext; rfl)
...
theorem Spec.liftWith_ExceptT
  ...
  Triple.iff.mpr (by simp [liftWith_ExceptT_wp f]; apply WP.wp_map'; ext; rfl)
...
theorem Spec.read_ReaderT (post : ρ → ρ → l) :
  ...
  Triple.iff.mpr (by rw [read_ReaderT_wp]; rfl)
...
theorem Spec.modifyGet_StateT (f : σ → α × σ) (post : α → σ → l) :
  ...
  Triple.iff.mpr (by rw [modifyGet_StateT_wp]; rfl)
...
theorem Spec.throw_ExceptT (err : ε) (post : α → l) (epost : e × (ε → l)) :
    Triple (epost.2 err) (MonadExceptOf.throw err : ExceptT ε m α) post epost :=
  Triple.iff.mpr (by rw [throw_ExceptT_wp])

/-- Spec for `tryCatch` on `ExceptT`. -/
theorem Spec.tryCatch_ExceptT (x : ExceptT ε m α) (h : ε → ExceptT ε m α) (post : α → l) (epost : e × (ε → l)) :
    Triple (wp x post (epost.1, fun e => wp (h e) post epost))
      (MonadExceptOf.tryCatch x h : ExceptT ε m α) post epost :=
  Triple.iff.mpr (tryCatch_ExceptT_wp x h)

/-- Spec for `orElse` on `ExceptT`. -/
theorem Spec.orElse_ExceptT (x : ExceptT ε m α) (h : Unit → ExceptT ε m α) (post : α → l) (epost : e × (ε → l)) :
    Triple (wp x post (epost.1, fun _ => wp (h ()) post epost))
      (OrElse.orElse x h : ExceptT ε m α) post epost :=
  Triple.iff.mpr (orElse_ExceptT_wp x h)

/-- Spec for `adapt` on `ExceptT`. -/
theorem Spec.adapt_ExceptT (f : ε → ε') (x : ExceptT ε m α) (post : α → l) (epost : e × (ε' → l)) :
    Triple (wp x post (epost.1, fun e => epost.2 (f e)))
...
theorem Spec.throw_Except (err : ε) :
    Triple (epost.2 err) (MonadExceptOf.throw err : Except ε α) post epost :=
...
theorem Spec.tryCatch_Except (x : Except ε α) (h : ε → Except ε α) :
    Triple (wp x post (.unit, fun e => wp (h e) post epost))
...
theorem Spec.orElse_Except (x : Except ε α) (h : Unit → Except ε α) :
    Triple (wp x post (.unit, fun _ => wp (h ()) post epost))
      (OrElse.orElse x h : Except ε α) post epost :=
  Triple.iff.mpr (by rw [orElse_Except_wp]; rfl)
...
theorem Spec.throw_ExceptT_lift [MonadExceptOf ε m] (err : ε) (post : α → l) (epost : e × (ε' → l)) :
    Triple (wp (MonadExceptOf.throw (ε:=ε) err : m (@Except.{u, u} ε' α))
        (fun r => match r with | .ok a => post a | .error e => epost.2 e) epost.1)
      (MonadExceptOf.throw (ε:=ε) err : ExceptT ε' m α) post epost :=
  Triple.iff.mpr (by rw [throw_lift_ExceptT_wp]; apply WP.wp_cons; intro r; cases r <;> rfl)
...
theorem Spec.throw_Option_lift [MonadExceptOf ε m] (err : ε) (post : α → l) (epost : e × l) :
  ...
  Triple.iff.mpr (by rw [throw_lift_OptionT_wp]; apply WP.wp_cons; intro r; cases r <;> rfl)
-/
...
theorem Spec.tryCatch_ExceptT_lift [MonadExceptOf ε m] (x : ExceptT ε' m α) (h : ε → ExceptT ε' m α)
    (post : α → l) (epost : e × (ε' → l)) :
    Triple (wp (MonadExceptOf.tryCatch (ε:=ε) x h : m (@Except.{u, u} ε' α))
        (fun | .ok a => post a | .error e => epost.2 e) epost.1)
      (MonadExceptOf.tryCatch (ε:=ε) x h : ExceptT ε' m α) post epost :=
  Triple.iff.mpr (by rw [tryCatch_lift_ExceptT_wp]; apply WP.wp_cons; intro r; cases r <;> rfl)
...
theorem Spec.tryCatch_OptionT_lift [MonadExceptOf ε m] (x : OptionT m α) (h : ε → OptionT m α)
  ...
  Triple.iff.mpr (by rw [tryCatch_lift_OptionT_wp]; apply WP.wp_cons; intro r; cases r <;> rfl)
-/
...
variable {α : Type u₁} {β : Type (max u₁ u₂)} {m : Type (max u₁ u₂) → Type v} {l : Type (max u₁ u₂)} {e : Type (max u₁ u₂)} [CompleteLattice l]
...
theorem Spec.forIn'_range {β : Type u} {m : Type u → Type v} {l : Type u} {e : Type u}
    [CompleteLattice l] [Monad m] [WP m l e]
...
theorem Spec.forIn'_rcc {α β : Type u} {m : Type u → Type v} {l : Type u} {e : Type u}
    [CompleteLattice l] [Monad m] [WP m l e] [LawfulMonad m]
...
theorem Spec.IterM.forIn_filterMapWithPostcondition {α β β₂ γ : Type w}
    ...
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Monad m] [LawfulMonad m] [Monad n] [LawfulMonad n] [Monad o] [LawfulMonad o] [WP o l e]
...
theorem Spec.IterM.forIn_filterMap {α β β₂ γ : Type w}
    ...
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Monad m] [LawfulMonad m] [Monad n] [LawfulMonad n] [WP n l e]
...
theorem Spec.IterM.foldM_filterMapWithPostcondition {α β γ δ : Type w}
    ...
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Iterator α m β] [Finite α m]
    [Monad m] [Monad n] [Monad o] [LawfulMonad m] [LawfulMonad n] [LawfulMonad o] [WP o l e]
...
theorem Spec.IterM.foldM_filterMapM {α β γ δ : Type w}
    ...
    [Monad o] [LawfulMonad o] [WP o l e]
    [IteratorLoop α m n] [IteratorLoop α m o]
    [LawfulIteratorLoop α m n] [LawfulIteratorLoop α m o]
    [MonadLiftT m n] [MonadLiftT n o] [LawfulMonadLiftT m n] [LawfulMonadLiftT n o]
...
theorem Spec.IterM.foldM_filterMap {α β γ δ : Type w}
    {m : Type w → Type w'} {n : Type w → Type w''}
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Iterator α m β] [Finite α m] [Monad m] [Monad n] [LawfulMonad m] [LawfulMonad n] [WP n l e]
    [IteratorLoop α m n]
...
theorem Spec.IterM.fold_filterMapWithPostcondition {α β γ δ : Type w}
    ...
    [Iterator α m β] [Finite α m]
    [Monad m] [LawfulMonad m]
    [Monad n] [LawfulMonad n] [WP n l e]
    [IteratorLoop α m n] [LawfulIteratorLoop α m n]
    [MonadLiftT m n] [LawfulMonadLiftT m n]
...
theorem Spec.IterM.fold_filterMapM {α β γ δ : Type w}
    ...
    [Iterator α m β] [Finite α m]
    [Monad m] [LawfulMonad m]
    [Monad n] [MonadAttach n] [LawfulMonad n] [WeaklyLawfulMonadAttach n] [WP n l e]
    [IteratorLoop α m n] [LawfulIteratorLoop α m n]
    [MonadLiftT m n] [LawfulMonadLiftT m n]
...
theorem Spec.IterM.fold_filterMap {α β γ δ : Type w}
    {m : Type w → Type w'}
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Iterator α m β] [Finite α m] [Monad m] [LawfulMonad m] [WP m l e]
...
theorem Spec.Iter.forIn_filterMapWithPostcondition {α β β₂ γ : Type w}
    ...
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Iterator α Id β]
    [Monad n] [LawfulMonad n] [Monad o] [LawfulMonad o] [WP o l e]
...
theorem Spec.Iter.forIn_filterMap {α β β₂ γ : Type w}
    ...
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Iterator α Id β]
    [Monad n] [LawfulMonad n] [WP n l e] [Finite α Id]
...
theorem Spec.Iter.foldM_filterMapWithPostcondition {α β γ δ : Type w}
    ...
    [Monad n] [Monad o] [LawfulMonad n] [LawfulMonad o] [WP o l e]
...
theorem Spec.Iter.foldM_filterMap {α β γ δ : Type w}
    {n : Type w → Type w'}
    {l : Type w} {e : Type w} [CompleteLattice l]
    [Iterator α Id β] [Finite α Id] [Monad n] [LawfulMonad n] [WP n l e]
    [IteratorLoop α Id n]
