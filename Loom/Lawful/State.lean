...
instance (σ ε : Type u₁)
  ...
  LawfulMonadStateOf (ExceptT ε m) l (EPost.cons (ε → l) e) σ where
  wp_get := by sorry
  wp_set := by sorry
...
instance (σ σ' : Type u₁)
  [MonadStateOf σ m] [MonadStateOf σ (PredTrans l e)] [LawfulMonadStateOf m l e σ] :
  LawfulMonadStateOf (StateT σ' m) (σ' → l) e σ where
  wp_get := by sorry
  wp_set := by sorry
  wp_modifyGet := by sorry
...
instance (σ ρ : Type u₁)
  [MonadStateOf σ m] [MonadStateOf σ (PredTrans l e)] [LawfulMonadStateOf m l e σ] :
  LawfulMonadStateOf (ReaderT ρ m) (ρ → l) e σ where
  wp_get := by sorry
  wp_set := by sorry
  wp_modifyGet := by sorry
...
--     apply LawfulWPMonadLift.lift_wp_trans (l := l) (e := e)
--     apply LawfulWPMonadLift.lift_monotone (m := m) (n := n)
...
instance (ρ ρ' : Type u₁)
  ...
  LawfulMonadReaderOf (ReaderT ρ' m) (ρ' → l) e ρ where
  wp_read := by sorry

instance (ρ ε : Type u₁)
  [MonadReaderOf ρ m] [MonadReaderOf ρ (PredTrans l e)] [LawfulMonadReaderOf m l e ρ] :
  LawfulMonadReaderOf (ExceptT ε m) l (EPost.cons (ε → l) e) ρ where
  wp_read := by sorry

instance (ρ σ : Type u₁)
  [MonadReaderOf ρ m] [MonadReaderOf ρ (PredTrans l e)] [LawfulMonadReaderOf m l e ρ] :
  LawfulMonadReaderOf (StateT σ m) (σ → l) e ρ where
  wp_read := by sorry
